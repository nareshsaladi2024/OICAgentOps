"""
A2A Server for ResubmitErrorsAgent

This module exposes the ResubmitErrorsAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("RESUBMIT_ERRORS_A2A_PORT", "10004"))

# Create the A2A application
print(f"🚀 Starting ResubmitErrorsAgent A2A Server on port {A2A_PORT}")
