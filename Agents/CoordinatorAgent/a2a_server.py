"""
A2A Server for CoordinatorAgent

This module exposes the CoordinatorAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("COORDINATOR_A2A_PORT", "10001"))

# Create the A2A application
print(f"🚀 Starting CoordinatorAgent A2A Server on port {A2A_PORT}")
