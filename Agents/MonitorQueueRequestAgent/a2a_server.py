"""
A2A Server for MonitorQueueRequestAgent

This module exposes the MonitorQueueRequestAgent via the A2A (Agent-to-Agent) protocol,
...
# Port configuration
A2A_PORT = int(os.environ.get("MONITOR_QUEUE_A2A_PORT", "10003"))

# Create the A2A application
print(f"🚀 Starting MonitorQueueRequestAgent A2A Server on port {A2A_PORT}")
